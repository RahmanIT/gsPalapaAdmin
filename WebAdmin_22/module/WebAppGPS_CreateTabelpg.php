...
$queryMd = ' CREATE TABLE IF NOT EXISTS "WYPOINT"."'.$namaTbMd.'" (
	...
	verfikasidate timestamp without time zone,
    vefi_nama character varying(70) COLLATE pg_catalog."default",
    vefi_waktu integer,
