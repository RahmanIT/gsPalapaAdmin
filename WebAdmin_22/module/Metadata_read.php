...
<div class="form-group">
  ...
  <input name="JUDUL" id="JUDUL" class="form-control" type="text" value="<?php echo $mythme->dataIdInfo[0]->idCitation->resTitle; ?>" placeholder="Nama Peta" size="50" maxlength="50" />
</div>
<div class="form-group">
   <label>Summary</label>
  <textarea name="SUMMARY" id="SUMMARY" cols="50" class="form-control" placeholder="Ringkasan Peta"><?php  echo $mythme->dataIdInfo[0]->idPurp; ?></textarea>
</div>
<div class="form-group">
  <label>Abstrak</label>
    <textarea name="ABSTRAK" cols="50" rows="5" class="form-control" placeholder="Abstrak"><?php echo $mythme->dataIdInfo[0]->idAbs; ?></textarea>
</div>
<div class="form-group">
...
<div class="col-lg-4 text-left">
		<div class="form-group">
    		...
    		<input type="text" name="BB" id="BB" class="form-control" value="<?php echo $mythme->Esri[0]->DataProperties->itemProps->nativeExtBox->westBL; ?>" />
		</div>
        <div class="form-group">
    		<label>Bujur Timur</label>
    		<input type="text" name="BT" id="BT" class="form-control" value="<?php echo $mythme->Esri[0]->DataProperties->itemProps->nativeExtBox->eastBL; ?>" />
		</div>
        <div class="form-group">
    		<label>Lintang Utara</label>
    		<input type="text" name="LU" id="LU" class="form-control" value="<?php echo $mythme->Esri[0]->DataProperties->itemProps->nativeExtBox->northBL; ?>" />
		</div>
        <div class="form-group">
    		<label>Lintang Selatan</label>
    		<input type="text" name="LS" id="LS" class="form-control" value="<?php echo $mythme->Esri[0]->DataProperties->itemProps->nativeExtBox->southBL; ?>"  />
      </div>                    
</div>
<!--------------------------------------------- -->    
