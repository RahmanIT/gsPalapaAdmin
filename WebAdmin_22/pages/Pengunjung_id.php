...
function TampilkanTabel(){
	...
	$("#loding").show();
	$.ajax({
	url: "<?php echo $nama_folder; ?>/Tabel-Pengunjung.jsp/",
	data: "Halaman="+pg,
	cache: false,
 ...
 <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Pengunjung
                            <small> trafik pengunjung web</small>
                        </h1>
                        <ol class="breadcrumb">
							<li >
                            ...
                            <li class="active">
                                <i class="fa fa-users"></i>  <a href="../../WebAdmin/pages/Pengunjung.html">Pengunjung</a>
                            </li>
                        </ol>
                    </div>
                </div>
           ...
           <!-- ========================================================================================== -->                    
 	          <div class="col-lg-12 text-center">
 	  					<div class="panel panel-default">
                              ...
                              <h3 onClick="TampilkanTabel()" style="cursor:pointer;">Daftar Pengunjung</h3>
                         <div align="right">
