...
function TampilkanTabel(){
	...
	$("#loding").show();
	$.ajax({
	url: "<?php echo $nama_folder; ?>/Tabel-Notifcation.jsp/",
	data: "Halaman="+pg,
	cache: false,
 ...
 <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Notification
                            <small> Log processing Web Admin</small>
                        </h1>
                        <ol class="breadcrumb">
						   <li>
                			...
                			<li class="active">
                                <i class="fa fa-bell"></i>  <a href="../../WebAdmin/pages/Notification.html">Notification</a>
                            </li>
                        </ol>
                    </div>
                </div>
           ...
           <!-- ========================================================================================== -->                    
 	          <div class="col-lg-12 text-center">
 	  					<div class="panel panel-default">
                              ...
                              <h3 onClick="TampilkanTabel()" style="cursor:pointer;">Notification</h3>
                         <div align="right">
