...
function TampilkanTabel(){
	...
	$("#loding").show();
	$.ajax({
	url: "<?php echo $nama_folder; ?>/Tabel-Pesan.jsp/",
	data: "Halaman="+pg,
	cache: false,
 ...
 <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           Pesan
                            <small> kontak dari pengunjung</small>
                        </h1>
                        <ol class="breadcrumb">
						   <li>
                			...
                			<li class="active">
                                <i class="fa fa-users"></i>  <a href="../../WebAdmin/pages/Pesan.html">Pesan user</a>
                            </li>
                        </ol>
                    </div>
                </div>
           ...
           <!-- ========================================================================================== -->                    
 	          <div class="col-lg-12 text-center">
 	  					<div class="panel panel-default">
                              ...
                              <h3 onClick="TampilkanTabel()" style="cursor:pointer;">Pesan Pengunjung</h3>
                         <div align="right">
